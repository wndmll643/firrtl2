// hier_cov.hierCoverage_ctrl_fold — production default (was v9a).
//
...
class hierCoverage_ctrl_fold extends Transform {
  ...
  private val params      = HierCovParams()    // ctrl_fold defaults (was v9a)
  ...
  private def writeCoverageSummary(circuit: Circuit, extModules: Set[String], topName: String): Unit = {
    ...
    val text =
      ...
      s"Total coverage points (hier_cov ctrl_fold, ctrl-input): ${totalCov}\n" +
